...
#ifndef INCLUDED_CUSTOMS_OFDM_CARRIER_PREAMBLE_H
#define INCLUDED_CUSTOMS_OFDM_CARRIER_PREAMBLE_H

#include <gnuradio/customs/api.h>
...
class CUSTOMS_API ofdm_carrier_preamble : virtual public gr::tagged_stream_block
{
public:
    typedef std::shared_ptr<ofdm_carrier_preamble> sptr;
...
#endif /* INCLUDED_CUSTOMS_OFDM_CARRIER_PREAMBLE_H */
